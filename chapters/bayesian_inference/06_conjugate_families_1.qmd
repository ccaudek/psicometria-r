...
::: {.callout-tip title="Soluzione 1" collapse="true"}
```r
...
::: {.callout-tip title="Soluzione 3" collapse="true"}
```r
# Caricamento delle librerie necessarie
library(ggplot2)
...
::: {.callout-tip title="Esercizio 4" collapse="true"}
...
::: {.callout-tip title="Soluzione 4" collapse="true"}
```r
# Caricamento delle librerie necessarie
library(ggplot2)
