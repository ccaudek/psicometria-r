...
3. *Conclusione.* Pur non superando la soglia convenzionale dell'intervallo credibile al 95% (entrambi gli intervalli includono zero), la *probabilità a posteriori che la differenza sia negativa è elevata (> 0.96)* per entrambi i parametri. Questi risultati indicano che:
