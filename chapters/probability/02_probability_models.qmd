...
<p class="capo">
  <span class="capo-initial" data-bg="1">D</span>
...
dat |>
  ...
  geom_bar(aes(y = after_stat(prop), group = 1),
           fill = okabe_ito["sky"], color = "white", width = 0.5) +
  labs(
...
venn.plot <- draw.pairwise.venn(
  ...
  category = c("A", "B"),
  fill = c(okabe_ito["sky"], okabe_ito["vermillion"]),
  alpha = 0.5,
  cat.col = c(okabe_ito["sky"], okabe_ito["vermillion"])
)
grid.draw(venn.plot)
```
