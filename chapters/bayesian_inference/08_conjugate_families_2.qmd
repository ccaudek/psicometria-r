...
La varianza a posteriori $\sigma_p^2$ è sempre inferiore o uguale a quella a priori $\sigma_0^2$, perché abbiamo aggiunto informazioni dai dati. In altre parole, l'incertezza sulla stima di $\mu$ si riduce con l'aumentare del numero di osservazioni. La varianza a posteriori rappresenta un bilanciamento tra l'incertezza a priori ($\sigma_0^2$) e l'informazione derivata dai dati ($\sigma^2/n$).
