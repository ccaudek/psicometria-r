...
ggplot(df, aes(x = island)) +
  geom_bar(fill = rinascimentale_primaria["seppia_scuro"]) +
...
```{r}
# Extract the colors as a vector
my_colors <- unname(rinascimentale_primaria)
