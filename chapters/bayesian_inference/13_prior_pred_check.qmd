...
bind_rows(
  ...
  ggplot(aes(x = y, fill = scenario)) +
  geom_density(alpha = 0.35) +
  labs(title = "Predittiva a priori",
...
as_tibble(yrep_l) |>
  ...
  ggplot(aes(x = y)) +
  geom_density() +
  labs(title = "Stan: predittiva a priori",
       x = "Valori simulati di y", y = "Densità")
```
...
tibble(p = pE, scenario = "E: prior larga") |>
  ...
  geom_density(alpha = 0.35) +
  labs(title = "Probabilità implicite dalla prior",
...
as_tibble(post_p) |>
  ...
  ggplot(aes(x = p)) +
  geom_density() +
  labs(title = "Stan: probabilità implicite dalla prior",
       x = "p(x)", y = "Densità")
```
