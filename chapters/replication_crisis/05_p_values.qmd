...
2. **Il p-valore è altamente variabile:** Essendo una trasformazione non lineare dello z-score (che ha un'interpretazione più chiara), il p-valore può comportarsi in modi non intuitivi, soprattutto con campioni piccoli.
