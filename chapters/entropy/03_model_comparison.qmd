...
In questo capitolo vedremo come costruire previsioni coerenti con l’incertezza sui parametri, come misurare la loro accuratezza e come confrontare modelli in modo fondato sia empiricamente sia teoricamente. L’obiettivo è fornire strumenti pratici e un quadro concettuale chiaro per guidare la scelta del modello più adatto al problema in esame.  

### Panoramica del capitolo {.unnumbered .unlisted}

* Costruire la distribuzione predittiva posteriore.  
* Valutare la qualità delle previsioni con il log-score.  
* Distinguere tra LPPD ed ELPD.  
* Usare LOO-CV per stimare l’ELPD.  
* Collegare l’ELPD alla divergenza di Kullback–Leibler.  
