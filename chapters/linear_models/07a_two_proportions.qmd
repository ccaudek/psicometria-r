...
Il **logit** è una trasformazione matematica che ci permette di lavorare con probabilità (che sono limitate tra 0 e 1) in un contesto di modello lineare. In particolare, il logit di una probabilità $p_i$ è definito come:
