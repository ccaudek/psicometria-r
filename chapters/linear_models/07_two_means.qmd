...
* $\varepsilon\_i \sim \mathcal{N}(0, \sigma^2)$ è un termine di errore casuale, che rappresenta la variabilità individuale non spiegata dal gruppo.
...
| Interpretazione      | Il p-value è condizionato da $H_0$                                | La probabilità di $\beta_1 > 5$ è condizionata dai dati |
| Incertezza           | Intervallo di confidenza                                             | Intervallo di credibilità                                  |
