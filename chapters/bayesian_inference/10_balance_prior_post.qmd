...
<p class="capo">
  <span class="capo-initial" data-bg="1">C</span>
onsideriamo un tipico scenario di valutazione psicologica: uno psicologo clinico deve valutare la possibile presenza di sintomi depressivi in un paziente. Confrontiamo due approcci:
</p>

* *Psicologo 1*: si affida esclusivamente a un test psicometrico standardizzato.
* *Psicologo 2*: integra i risultati del test con storia personale, storia clinica e fattori di rischio.

Quale approccio risulta più accurato?

La chiave è nel concetto di *probabilità a priori* (prior), ossia le conoscenze disponibili prima di raccogliere nuovi dati. Nel nostro esempio, la storia clinica rappresenta l’informazione a priori, mentre il test psicometrico fornisce i dati osservati.

Nell’approccio bayesiano, il prior funge da lente interpretativa che:

* contestualizza i risultati, migliorando la sensibilità diagnostica,
* riduce gli errori, evitando interpretazioni rigide,
* personalizza la valutazione sul singolo paziente.

È però essenziale che il prior sia fondato su evidenze solide, senza diventare troppo rigido da distorcere l’analisi. Lo stesso meccanismo guida molte inferenze quotidiane: ad esempio, vedere in aula una persona con un manuale di statistica ci porta a pensare che sia uno studente di psicologia, basandoci sull’esperienza accumulata.

In questo capitolo esploreremo il ruolo delle *priori* nel processo di aggiornamento bayesiano.
