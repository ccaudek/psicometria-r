...
ggplot(data.frame(theta, prob = priori_unif), aes(x = theta, y = prob)) +
  geom_col(width = 0.08, fill = rinascimentale_primaria["seppia_scuro"]) +
...
ggplot(data.frame(theta, prior = prior_beta_2_2), aes(x = theta, y = prior)) +
  geom_line(linewidth = 1.2, fill = rinascimentale_primaria["seppia_scuro"]) +
...
ggplot(df_long, aes(x = theta, y = Densità, color = Distribuzione)) +
  geom_line(size = 1.2, fill = rinascimentale_primaria["seppia_scuro"]) +
