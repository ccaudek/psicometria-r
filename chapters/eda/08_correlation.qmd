...
group_colors <- c(
  "Pazienti"  = rinascimentale_primaria[["seppia_scuro"]],
  "Controlli" = rinascimentale_primaria[["blu_oltremare"]]
)
...
ggplot(anscombe_m, aes(x, y)) +
  geom_point(size = 3, color = "white", fill = rinascimentale_primaria[["seppia_scuro"]], shape = 21) +
