...
* **ess\_bulk**: dimensione effettiva del campione nella parte centrale della distribuzione. Misura quanto i draw MCMC siano *non correlati*. Qui è circa 5663: significa che i 16.000 campioni (4 catene × 4000) “valgono” come oltre 5600 campioni indipendenti. È un valore molto alto, quindi la stima della media e di altre statistiche centrali è molto stabile.
* **ess\_tail**: dimensione effettiva del campione per le code della distribuzione. Qui è circa 6067: anche in questo caso le stime dei quantili estremi (ad esempio intervalli al 95%) sono affidabili.
