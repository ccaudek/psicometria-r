...
1. **Consegna degli esercizi assegnati**  
   Gli esercizi devono essere consegnati entro le scadenze indicate.  
   - Un’elaborazione **parziale o insufficiente** (ad esempio, la consegna di un numero ridotto di esercizi o soluzioni superficiali) comporterà una penalizzazione di **5 punti** sul voto finale.
   - Le scadenze e le modalità di consegna saranno comunicate in aula e pubblicate sulle piattaforme del corso.

2. **Partecipazione alle prove in itinere**  
   È obbligatorio sostenere **tutte e tre le prove parziali** previste nel corso del semestre. L’assenza a una o più prove senza giustificato motivo comporterà l’esclusione dalla qualifica di studente frequentante.  

### Attività previste per gli studenti frequentanti


#### Prove Parziali 1 e 2

- Le prove si terranno sulla piattaforma Moodle.  
- Le domande sono presentate in sequenza: una volta risposta una domanda, non è possibile tornare indietro.  
- I quiz sono personalizzati: le domande vengono estratte casualmente da un database comune.  
- È obbligatorio l’utilizzo del software **R** e dei pacchetti specifici illustrati durante le lezioni.  

#### Prova Parziale 3

- **Struttura e requisiti**:  
  - Svolta **in aula**, richiede l’analisi statistica di uno o più articoli scientifici resi disponibili su Moodle.  
  - Utilizzo esclusivo dei dataset originali forniti dagli autori degli articoli.  

- **Obiettivi della prova**:  
  1. **Replicare risultati**: riprodurre parzialmente le analisi presentate negli articoli.  
  2. **Applicare metodologie bayesiane**: rielaborare le analisi degli autori sostituendo l’approccio frequentista con tecniche bayesiane.  
  3. **Confronto critico**: evidenziare analogie, divergenze e implicazioni tra i risultati ottenuti con i due paradigmi statistici.  

- **Competenze valutate**:  
  1. **Comprensione del disegno sperimentale**:  
     - Analisi delle scelte metodologiche degli autori e del loro impatto sull’interpretazione dei dati.  
     - Valutazione di punti di forza e criticità nel setup sperimentale.  
  2. **Analisi critica dei risultati**:  
     - Formulazione di interpretazioni alternative dei dati, oltre a quelle proposte negli articoli.  
     - Identificazione di limiti metodologici, campionari o teorici negli studi.  
  3. **Capacità tecniche**:  
     - Padronanza nell’uso di strumenti statistici complementari (bayesiano vs. frequentista).  
     - Rigore nella documentazione e giustificazione delle scelte analitiche.  

#### Laboratorio Opzionale (Bonus) 

- **Partecipazione**:  
  - Gli studenti possono ottenere **2 punti bonus** partecipando a un’attività di laboratorio aggiuntiva.  
- **Iscrizione**:  
  - Compilare il modulo Google dedicato, disponibile su Moodle, entro la scadenza indicata.  

**Note**: Tutte le prove richiedono una preparazione autonoma e la familiarità con i materiali didattici forniti. Si consiglia di consultare regolarmente Moodle per aggiornamenti e risorse integrative.
