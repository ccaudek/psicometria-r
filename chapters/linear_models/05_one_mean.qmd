...
p <- ggplot() +
  ...
  labs(
    x = NULL, y = "Densità",
    title = stringr::str_wrap("Confronto brms vs Stan", width = 60),
    subtitle = "brms = blu · Stan = marrone"
  ) +
  theme_manuscript() +
...
ggplot(ppc_df, aes(x = stat)) +
  ...
  labs(x = "Media(y_rep)", y = "Densità",
       title = "PPC: media osservata vs replicate")
```
