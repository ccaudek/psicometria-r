...
Per i lettori interessati ad approfondire l'applicazione dei metodi bayesiani alla regressione lineare, oltre al già citato testo di @Johnson2022bayesrules, si raccomanda la consultazione di *[Regression and Other Stories](https://avehtari.github.io/ROS-Examples/)*. Questo volume offre una guida pratica ricca di esempi applicati, rappresentando una risorsa preziosa per comprendere come implementare le tecniche bayesiane nell'analisi della regressione e come interpretarne i risultati in contesti di ricerca reali.
