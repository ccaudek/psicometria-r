...
> “From a Bayesian standpoint, the question ‘how large a sample?’ can only be answered by reference to the losses and gains that accrue from the decision to observe.”
>
> — **Anthony O’Hagan**, *Bayesian Inference* (1994, p. 219)
:::
...
ggplot(res, aes(x = CIw89)) +
  geom_histogram(binwidth = 0.02, fill = okabe_ito["sky"], color = "white") +
