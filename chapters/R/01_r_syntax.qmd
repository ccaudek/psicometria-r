...
- Leggere il capitolo *Getting Started with Data in R* di [Statistical Inference via Data Science: A ModernDive into R and the Tidyverse (Second Edition)](https://moderndive.com/v2/), sezioni 1.1-1.3.
