...
* capire cos’è un workflow bayesiano e perché è utile nella ricerca;
* distinguere le principali fasi del processo: formulare, verificare e migliorare un modello;
* conoscere le verifiche predittive, cioè le simulazioni che ci aiutano a capire se il modello funziona;
* introdurre l’idea di *analisi multiverso*, un approccio che esplora più modelli alternativi in modo trasparente.
:::
