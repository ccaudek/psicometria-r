...
ggplot(df, aes(x = theta, y = likelihood, color = caso)) +
  ...
  labs(
    title = "Confronto tra funzioni di verosimiglianza",
    subtitle = "Con più lanci la curva diventa più stretta → maggiore precisione",
    x = expression(theta),
    y = "Verosimiglianza"
  ) +
...
ggplot(data, aes(x = theta, y = likelihood)) +
  ...
  labs(
    title = "Funzione di Verosimiglianza Binomiale\n(23 successi su 30 prove)",
    x = expression(theta),
    y = "Verosimiglianza"
  ) 
```
...
ggplot(data.frame(mu = mu_values, likelihood = likelihood), 
  ...
  geom_line(linewidth = 1.2, color = "steelblue") +
  labs(
    title = "Funzione di verosimiglianza gaussiana\n(QI osservato: 114)",
    x = "Media μ",
    y = "Verosimiglianza"
  )
```
...
ggplot(
  ...
  labs(
    title = "Funzione di log-verosimiglianza per i punteggi BDI-II",
    subtitle = "Distribuzione normale con σ = 6.5 nota",
    x = expression(mu),
...
ggplot(df, aes(x = theta, y = likelihood)) +
  ...
  labs(
    title = "Funzione di verosimiglianza binomiale",
    subtitle = "7 successi su 10 prove",
    x = expression(theta),
    y = "Verosimiglianza"
  ) +
