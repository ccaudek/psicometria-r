...
- Studiare il @sec-apx-sums dell'Appendice. 
...
In questo esercizio, lavorerai con i dati della **Satisfaction With Life Scale (SWLS)** raccolti da 10 studenti. Il tuo compito sarà analizzare questi dati **sia manualmente su carta** che utilizzando **R**.
...
::: {.callout-tip title="Soluzione 2" collapse="true"}
**Parte 1: Calcolo Manuale**
