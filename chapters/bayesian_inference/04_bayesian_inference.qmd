...
egli ultimi vent’anni l’inferenza bayesiana è passata da “curiosità matematica” a strumento di lavoro quotidiano in campi che vanno dalla biologia all’economia, dalla medicina alle scienze cognitive. In psicologia la sua popolarità è legata a due vantaggi pratici: la possibilità di integrare conoscenze pregresse (per esempio risultati di studi precedenti o expertise clinica) all’interno dell’analisi, e la capacità di gestire al meglio campioni piccoli o rumorosi, frequenti nei contesti sperimentali e clinici.
</p>
