...
Immaginiamo di voler stimare la probabilità \$\theta\$ che uno studente risponda correttamente a una domanda di un test di memoria.
Abbiamo osservato che, su 9 domande, lo studente ha risposto correttamente a 6.
Questo può essere modellato con una **verosimiglianza binomiale**.
Ora ci chiediamo: *come cambiano le nostre conclusioni se assumiamo priori differenti?*
...
### Passo 2: funzione per calcolare e visualizzare la posteriori
...
### Priore esponenziale centrata su 0.5
...
**Commento**: questa prior esprime l’idea che lo studente abbia circa il 50% di probabilità di rispondere correttamente.
La posteriori viene “attirata” verso 0.5, pur tenendo conto dei dati (6 su 9 ≈ 0.67).
Il risultato finale è un compromesso: né tutto nei dati, né tutto nella prior.
...
Un esempio classico in cui i calcoli diventano semplici è il modello *Beta-Binomiale*.
La distribuzione Beta è coniugata alla Binomiale: ciò significa che la forma della posteriori rimane una Beta.
...
Con un priore uniforme, i dati (6 su 9) guidano quasi interamente la stima.
Con un priore più informativo, la posteriori si sposta nella direzione suggerita dalle credenze pregresse.
