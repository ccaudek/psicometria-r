...
ggplot(df, aes(x = condizione, y = punteggio, fill = condizione)) +
  ...
  labs(x = "Condizione sperimentale", y = "Punteggio di depressione",
       title = "Distribuzioni per condizione") +
