...
group_colors <- c(
  "Pazienti"  = renaissance_palette[["warm_red"]],
  "Controlli" = renaissance_palette[["warm_blue"]]
)
...
ggplot(anscombe_m, aes(x, y)) +
  geom_point(size = 3, color = renaissance_palette[["warm_red"]], fill = renaissance_palette[["secondary"]], shape = 21) +
