...
<p class="capo">
  <span class="capo-initial" data-bg="3">I</span>
...
tibble(beta = b_slope_draws$b_year_c) %>%
  ...
  labs(
    title = "Distribuzione a posteriori di β (b_year_c)",
    x = "Valore di β",
...
In questo capitolo abbiamo visto come utilizzare *brms* per stimare e interpretare modelli lineari in ottica bayesiana.
Abbiamo esplorato:
