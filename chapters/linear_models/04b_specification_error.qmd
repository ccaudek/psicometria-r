...
<p class="capo">
  <span class="capo-initial" data-bg="1">U</span>no degli aspetti più delicati dei modelli di regressione è il rischio di *errore di specificazione* [@ramsey1969tests]. Questo si verifica quando il modello che stimiamo non corrisponde al “vero” modello che ha generato i dati. In particolare, parleremo del caso in cui *omettiamo una variabile esplicativa* che:
</p>
