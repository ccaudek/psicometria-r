...
ggplot(data.frame(b_hat = b_hat), aes(x = b_hat)) +
  geom_histogram(aes(y = after_stat(density)),
                 bins = 50,
                 fill = rinascimentale_primaria["seppia_scuro"],        # istogramma
                 color = "white") +
  stat_function(fun = dnorm,
                args = list(mean = mean_b_hat, sd = sd_b_hat),
                color = rinascimentale_primaria["porpora_antico"], # curva normale
                linewidth = 1) +
  labs(
