...
Da dove provengono i numeri che chiamiamo "probabilità"? Per rispondere a questa domanda, faremo riferimento alla trattazione di [Michael Betancourt](https://github.com/betanalpha/quarto_chapters/tree/main). Questo capitolo propone una versione semplificata del suo lavoro, preservando la chiarezza della notazione e le figure originali per garantire continuità con l'approccio dell'autore.
